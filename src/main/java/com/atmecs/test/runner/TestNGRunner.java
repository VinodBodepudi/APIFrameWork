package com.atmecs.test.runner;
...
public class TestNGRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        initialize();
        suitesToRun =
                testNGEngine.getSuitesToRunForWebServices(PropertyParser.readEnvOrConfigProperty("SuiteFileName"),
    ...
    public static void uploadTestNGResultsXml() {
        try {
            String uploadUrl = PropertyParser.readEnvOrConfigProperty("testreport.uploadurl");
            ...
            String projectName = PropertyParser.readEnvOrConfigProperty("ProjectName");
            String response =
                    testReportUploadClient.upload(dataProvider.getSessionId(), projectName, "Web Services", "QA", "Regression",
